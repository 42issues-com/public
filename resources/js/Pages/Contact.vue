...
const subscriptionShow = ref(false);
</script>
    ...
    <GuestLayout>
        <div class="relative isolate bg-white">
            <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                <div class="relative px-6 py-24 sm:py-32 lg:static lg:px-8">
                            ...
                            <div>
                                ...
                                <div class="mt-2.5">
                                    <input
                                        ...
                                        class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-primary-600"
                                    />
                                    <p
        ...
        <NewsletterSection
            @close-notification="subscriptionShow = false"
            @show-notification="subscriptionShow = true"
        />
        ...
        <ContactNotification
            :show="contactShow"
            @close-notification="contactShow = false"
        />
